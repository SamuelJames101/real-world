...
import { 
    ...
    signOutUser } from '../../utils/firebase.utils';
...
export function* userSagas(){
    yield all([call(onCheckUserSession), call(onGoogleSignInStart), call(onEmailSignInStart), call(onEmailSignUpStart), call(onSignOutStart), call(onEmailSignUpSuccess)]);
}